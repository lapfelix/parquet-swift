...
public final class Int64ColumnReader {
    ...
    internal func readAllWithAllLevels() throws -> (values: [Int64?], definitionLevels: [UInt16], repetitionLevels: [UInt16]) {
        var values: [Int64?] = []
        var defLevels: [UInt16] = []
    ...
    ///   - maxRepLevel=2: `[[[Int64?]?]?]` (list of optional lists of optional values)
    ///   - maxRepLevel=3: `[[[[Int64?]?]?]?]` (and so on)
    ///
