...
public final class StringColumnReader {
    ...
    internal func readAllWithLevels() throws -> (values: [String?], definitionLevels: [UInt16]) {
        var values: [String?] = []
    ...
    internal func readAllWithAllLevels() throws -> (values: [String?], definitionLevels: [UInt16], repetitionLevels: [UInt16]) {
        var values: [String?] = []
        var defLevels: [UInt16] = []
